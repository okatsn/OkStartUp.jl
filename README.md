...
!!! note Checklist
    - [ ] Create an empty repository (namely, `https://github.com/okatsn/OkStartUp.jl.git`) on github, and push the local to origin. See [connecting to remote](#tips-for-connecting-to-remote).
